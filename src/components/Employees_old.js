            ...
            <form onSubmit={formik.handleSubmit} className="employee-form">
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label style={{ color: theme.palette.text.primary }}>Name *</label>
                  <input
                    name="name"
                  ...
                  {formik.touched.name && formik.errors.name && (
                    <p className="error-message" style={{ color: theme.palette.error.main }}>
                      {formik.errors.name}
                    </p>
                  )}
                </div>
          ...
          {filteredEmployees.length === 0 && (
            <div className="no-data">
              <p style={{ color: theme.palette.text.secondary }}>
                No employees found. {searchTerm && 'Try adjusting your search terms.'}
              </p>
            </div>
          )}
          </div>
